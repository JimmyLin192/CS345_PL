...
test_FUNCTION :- 
    ...
    test('T_FUNC_7', ['var', 'x', '<-', 5, ';', 'function', 'foo', '(', 'z', ')', '{', 'return', '(', 'y', ')', '.', '}', ';', 'function', 'bar', '(', 'y', ')', '{', 'var', 'x', '<-', 8, ';', 'var', 'w', '<-', 9, ';', 'return', 'foo', '(', 0, ')', '.', '}', ';', 'return', 'bar', '(', 0, ')', '.'], 'eval_fail'),
    test('T_FUNC_8', ['function', 'foo', '(', 'x', ')', '{', 'var', 'out', '<-', '(', 'x', '*', 2, ')', ';', 'return', 'out', '.', '}', ';', 'var', 'z', '<-', 'foo', '(', 3, ')', ';', 'return', 'out', '.'], 'eval_fail'),
    writeln('').
...
test_RECURSION :-
    ...
    test('T_SQUARE_ROOT', ['var', 'errorM', '<-', 0.000000001, ';', 'function', 'squareroot', '(', 'x', ')', '{', 'var', 'a', '<-', -1, ';', 'var', 'b', '<-', 'x', ';', 'if', '(', 'x', '>', 0, ')', 'then', 'while', '(', 'abs', '(', '(', 'a', '-', 'b', ')', ')', '>', 'errorM', ')', 'do', 'a', '<-', '(', '(', 'a', '+', 'b', ')', '/', 2, ')', ';', 'b', '<-', '(', 'x', '/', 'a', ')', '.', 'done', '.', 'endif', ';', 'return', 'a', '.', '}', ';', 'function', 'abs', '(', 'x', ')', '{', 'var', 'out', '<-', 'x', ';', 'if', '(', 'x', '<', 0, ')', 'then', 'out', '<-', '(', -1, '*', 'out', ')', '.', 'endif', ';', 'return', 'out', '.', '}', ';', 'return', 'squareroot', '(', 2, ')', '.'], 1.4142135625249321), 
    writeln('').
